...
<asp:Content ContentPlaceHolderID="TestContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        test('creating hidden windows and opening them', function() {
            var dialog = $t.window.create({
                html: "foo",
                visible: false
            });
        ...
        test('creating hidden windows from existing element', function() {
            var element = $("<div />").appendTo(document.body),
                dialog = $t.window.create(element, {
                    html: "foo",
                    visible: false
                });

            ok(element.is(":hidden"));
        });
