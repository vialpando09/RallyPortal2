...
<script type="text/javascript">
        ...
        test('apply on empty selection', function() {
            editor.value(' ');
            var formatter = new ListFormatter('ul');
            formatter.apply([editor.body.firstChild]);
        ...
        test("remove in selection between different table rows", function() {
            editor.value("<table><tbody><tr><td><ul><li>foo</li></ul></td><td><ul><li>bar</li></ul></td></tr></tbody></table>");

            var range = editor.createRange(),
                tr = editor.document.getElementsByTagName("tr")[0];
            ...
            formatter.toggle(range);
            equal(editor.value(), "<table><tbody><tr><td><p>foo</p></td><td><p>bar</p></td></tr></tbody></table>");
        });
