...
//        });
        ...
        test('getGroupHtml for first level renders lines class by default', function() {
            var html = new $.telerik.stringBuilder();
        ...
        test('getGroupHtml for first level does not render lines class if showLines is false', function() {
            var html = new $.telerik.stringBuilder();
...
<li class="t-item t-last"><div class="t-bot"><span class="t-in">Should not be visible</span></div></li>\
        ...
        test('getItemHtml honors HtmlAttributes', function() {
            var html = new $.telerik.stringBuilder();
            ...
            equal($item.find('.t-bot').data('foo'), "bar");
        });

        test('getItemHtml honors class in HtmlAttributes', function() {
            var html = new $.telerik.stringBuilder();
            ...
            ok($item.find('.t-bot').hasClass("foo"));
        });

        test('getItemHtml honors ImageHtmlAttributes', function() {
            var html = new $.telerik.stringBuilder();
            ...
            equal($item.find('img').data("foo"), "bar");
        });
</script>
