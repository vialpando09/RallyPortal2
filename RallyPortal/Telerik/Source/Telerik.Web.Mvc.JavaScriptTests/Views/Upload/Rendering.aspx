...
<script type="text/javascript">
    ...
    function moduleSetup() {
        ...
        _getSupportsDrop = $.telerik.upload.prototype._getSupportsDrop;
    }

    function moduleTeardown() {
        $.telerik.upload.prototype._getSupportsMultiple = _getSupportsMultiple;
        $.telerik.upload.prototype._getSupportsDrop = _getSupportsDrop;
    }
    ...
    module("Upload / Rendering / Drag and drop", {
        setup: function() {
            $.telerik.upload.prototype._getSupportsDrop = function() { return true; };
    ...
    test("drop zone is not rendered when not supported by the browser", function() {
        $.telerik.upload.prototype._getSupportsDrop = function() { return false; };
        uploadInstance = createUpload();
