...
<script type="text/javascript">
        ...
        function moduleSetup() {
            _getSupportsFormData = $.telerik.upload.prototype._getSupportsFormData;
            $.telerik.upload.prototype._getSupportsFormData = function() { return true; };
            $.telerik.upload.prototype._alert = function() { };
        }

        function moduleTeardown() {
            $.telerik.upload.prototype._getSupportsFormData = _getSupportsFormData;
            $.mockjaxClear();
        }
...
<script type="text/javascript">
        ...
        test("user data can't be set on retry", function() {
            var id = 1;
