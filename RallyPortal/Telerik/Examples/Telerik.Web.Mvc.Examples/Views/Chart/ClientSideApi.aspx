    ...
    <% using (Html.Configurator("Client API").Begin()) { %>
        <ul style="margin-top:2em">
            <li>
                ...
                %>
                <button class="t-button" onclick="rebind()" style="margin-top:0;vertical-align:middle;">rebind</button>
            </li>
            <li>
                <button class="t-button" onclick="refresh()" style="width:auto">refresh chart</button>
            </li>
        </ul>
    <% } %>
