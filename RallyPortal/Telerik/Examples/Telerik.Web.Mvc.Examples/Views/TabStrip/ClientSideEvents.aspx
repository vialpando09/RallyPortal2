	    ...
	    <% Html.Telerik().TabStrip()
                ...
                .Items(tabstrip =>
                {
                    tabstrip.Add().Text("Based on jQuery")
                        ...
                        {%>
                            <p>
                                The client-side code of the Telerik Extensions for ASP.NET MVC is based on the open source
                                and Microsoft-supported jQuery JavaScript library.  By using jQuery, the Telerik Extensions
                    ...
                    tabstrip.Add().Text("Open-source")
                        ...
                        {%>
                            <p>
                                The Telerik Extensions for ASP.NET MVC are licensed under the widely adopted GPLv2.
                                ...
                                Telerik provides a commercial license with support included.
                            </p>
                        <%});
